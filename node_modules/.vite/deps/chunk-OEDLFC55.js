...
// node_modules/@react-three/fiber/dist/index-bb759d07.esm.js
...
// node_modules/@react-three/fiber/node_modules/suspend-react/dist/index.js
...
var globalCache = [];
function query(fn, keys2, preload2 = false, config = {}) {
...
function applyProps$1(instance, data) {
  ...
  for (let i2 = 0; i2 < changes.length; i2++) {
    ...
    if (isEvent) {
      ...
      if (!rootState.linear && currentInstance[key] instanceof Texture && // sRGB textures must be RGBA8 since r137 https://github.com/mrdoob/three.js/pull/23129
      currentInstance[key].format === RGBAFormat && currentInstance[key].type === UnsignedByteType) {
        currentInstance[key].encoding = sRGBEncoding;
      }
    }
    invalidateInstance(instance);
  }
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OEDLFC55.js.map
